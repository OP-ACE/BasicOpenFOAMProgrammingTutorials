...
int main(int argc, char *argv[])
{
	...
	Info << "从字典文件 transportProperties 中读取字典信息,放到 iodict_nu中: \n" << endl;

	IOdictionary iodict_nu
	(
		IOobject
		(
	...
	(
		...
		iodict_nu.lookup("nu") 
		// this takes the value from the dictionary and returns it, passing it to the object constructor as an argument
	);
